...
- The **mean** of Total Steps per Day is: **`r mean1`** 
- The **median** of Total Steps per Day is: **`r median1`**   
...
The interval containing the maximum number of steps across all days is **`r maxsteps`**.
...
There are **`r missingNo`** missing values in the dataset.
...
- The NEW **mean** of Total Steps per Day is: **`r mean2`** 
- The NEW **median** of Total Steps per Day is: **`r median2`**   
